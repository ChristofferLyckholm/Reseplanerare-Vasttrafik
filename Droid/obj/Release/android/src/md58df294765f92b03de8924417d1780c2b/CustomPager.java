...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Stops.CustomPager, stops", CustomPager.class, __md_methods);
	}


	public CustomPager (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CustomPager.class)
			mono.android.TypeManager.Activate ("Stops.CustomPager, stops", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}


	public CustomPager (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CustomPager.class)
			mono.android.TypeManager.Activate ("Stops.CustomPager, stops", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
