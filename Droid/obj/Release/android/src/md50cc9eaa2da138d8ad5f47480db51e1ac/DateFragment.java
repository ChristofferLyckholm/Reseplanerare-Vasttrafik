...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("stops.DateFragment, stops", DateFragment.class, __md_methods);
	}
	...
	public DateFragment ()
	{
		...
		if (getClass () == DateFragment.class)
			mono.android.TypeManager.Activate ("stops.DateFragment, stops", "", this, new java.lang.Object[] {  });
	}
