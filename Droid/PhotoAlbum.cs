...
namespace stops
{
	...
	public class PhotoAlbum
	{
		...
		static Photo[] mBuiltInPhotos = {
			new Photo { mPhotoID = Resource.Drawable.abc_ratingbar_full_material,
				mCaption = "Buckingham Palace" },
			new Photo { mPhotoID = Resource.Drawable.abc_menu_hardkey_panel_mtrl_mult,
				mCaption = "The Eiffel Tower" },
			new Photo { mPhotoID = Resource.Drawable.abc_list_selector_disabled_holo_dark,
				mCaption = "The Louvre" },
			new Photo { mPhotoID = Resource.Drawable.star_dark,
				mCaption = "Before mobile phones" },
			new Photo { mPhotoID = Resource.Drawable.bigicon,
